...
package ca.mudar.parkcatcher.receivers;
 ...
 * we lose connectivity the relevant Service classes will automatically disable
 * passive Location updates and queue pending checkins. This class will restart
 * the checkin service to retry pending checkins and re-enables passive location
 * updates.
 */
public class ConnectivityChangedReceiver extends BroadcastReceiver {
    protected static String TAG = "ConnectivityChangedReceiver";
