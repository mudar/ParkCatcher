...
package ca.mudar.parkcatcher.utils.base;

import android.location.Location;
import android.location.LocationListener;

/**
 * Interface definition for a Last Location Finder. Classes that implement this
 * interface must provide methods to find the "best" (most accurate and timely)
 * previously detected location using whatever providers are available. Where a
 * timely / accurate previous location is not detected, classes should return
 * the last location and create a one-shot update to find the current location.
 * The one-shot update should be returned via the Location Listener passed in
 * through setChangedLocationListener.
 */
