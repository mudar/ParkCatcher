 ...
 * location updates optimized for each platform release. Uses broadcast Intents
 * to notify the app of location changes.
 */
public abstract class LocationUpdateRequester {
     ...
     * 
     * @param minTime Minimum time that should elapse between location update
     *            broadcasts.
     * @param minDistance Minimum distance that should have been moved between
     *            location update broadcasts.
     * @param criteria Criteria that define the Location Provider to use to
     *            detect the Location.
     * @param pendingIntent The Pending Intent to broadcast to notify the app of
