...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
         ...
         */
        ((TextView) view.findViewById(R.id.about_project_version))
        ...
        ((TextView) view.findViewById(R.id.about_credits_3)).setMovementMethod(method);
        ((TextView) view.findViewById(R.id.about_open_data)).setMovementMethod(method);
        ((TextView) view.findViewById(R.id.about_project_url)).setMovementMethod(method);
