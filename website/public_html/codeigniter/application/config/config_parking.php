...
$config['parking_api_posts_version'] = 1;
$config['parking_api_panels_version'] = 1;
$config['parking_api_panels_codes_version'] = 1;
$config['parking_api_panels_codes_rules_version'] = 1;
...
$config['parking_img_panels_codes_path'] = "./img/panels_codes/";

$config['parking_year_day_first'] = 0;	// As in PHP's date('z')
$config['parking_year_day_last'] = 364;	// Leap year's last day is 365

$config['parking_key_geocoder'] = __PARKING_KEY_GEOCODER__;
$config['parking_key_api_export'] = __PARKING_KEY_API_EXPORT__;
